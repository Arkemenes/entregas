...
//////////////////////////////////////////////////////////////////////////
#define PIN_ECHO_MASK	PIO_PC12
#define PIN_ECHO_PIO	PIOC
#define PIN_ECHO_ID		ID_PIOC
#define PIN_ECHO_TYPE	PIO_INPUT
#define PIN_ECHO_ATTR	PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_RISE_EDGE
...
//////////////////////////////////////////////////////////////////////////
#define PORT_TRIGGER PIOC
#define PORT_ECHO PIOC
//////////////////////////////////////////////////////////////////////////
...
static void configure_buttons(void)
{
	...
	pmc_enable_periph_clk(PIN_ECHO_ID);	
	...
	pio_set_input(PIN_ECHO_PIO, PIN_ECHO_MASK, PIO_PULLUP | PIO_DEBOUNCE);
	pio_set_debounce_filter(PIN_PUSHBUTTON_1_PIO, PIN_PUSHBUTTON_1_MASK, 10);
	pio_set_debounce_filter(PIN_PUSHBUTTON_2_PIO, PIN_PUSHBUTTON_2_MASK, 10);
	pio_set_debounce_filter(PIN_ECHO_PIO, PIN_ECHO_MASK, 10);	
	...
	pio_handler_set(PIN_ECHO_PIO, PIN_ECHO_ID, PIN_ECHO_MASK, PIO_IT_FALL_EDGE | PIO_PULLUP, Button2_Handler);	
	pio_enable_interrupt(PIN_PUSHBUTTON_1_PIO , PIN_PUSHBUTTON_1_MASK);
	pio_enable_interrupt(PIN_PUSHBUTTON_2_PIO , PIN_PUSHBUTTON_2_MASK);
	pio_enable_interrupt(PIN_ECHO_PIO , PIN_ECHO_MASK);
	NVIC_SetPriority((IRQn_Type) PIN_PUSHBUTTON_1_ID, 0);
	NVIC_SetPriority((IRQn_Type) PIN_PUSHBUTTON_2_ID, 0);	
	NVIC_SetPriority((IRQn_Type) PIN_ECHO_ID, 0);	
	NVIC_EnableIRQ((IRQn_Type) PIN_PUSHBUTTON_1_ID);
	NVIC_EnableIRQ((IRQn_Type) PIN_PUSHBUTTON_2_ID);
	NVIC_EnableIRQ((IRQn_Type) PIN_ECHO_ID);
	}
